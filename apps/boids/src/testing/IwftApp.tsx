...
// the page.route trampoline. boids has no database (ADR 0006), so — unlike
// hub — there's no DbClient handle to seed and no async setup: mountApp's
// `seed` option is simply never used. The `failures` link and testUserAuth
// auth seam are DB-independent and still work.
import {
  ConsoleLogger,
  createContext,
  createDispatcher,
