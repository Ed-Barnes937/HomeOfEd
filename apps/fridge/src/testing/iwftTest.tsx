// fridge's .iwft fixture: registers the app-specifics (harness element + root
...
import { FridgePagePom } from './FridgePagePom.ts'
import { IwftApp } from './IwftApp.tsx'

export const test = createIwftTest({
  harness: <IwftApp />,
  createRoot: (page) => new FridgePagePom(page),
})
