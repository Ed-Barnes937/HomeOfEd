 ...
 * from the species byte. Off the frame path since ticket 06 packed the 2D
 * renderer's own loop — this remains for the WebGL renderer's `snapshot()`
 * (scene thumbnails, user-initiated).
 */
