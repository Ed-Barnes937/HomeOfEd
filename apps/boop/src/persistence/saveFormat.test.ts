...
describe('parseSaveDocument (defensive decode)', () => {
  ...
  it.each([
    ...
    [
      ...
      withWorking({ ...boop, patterns: new Array(11).fill(patternToStored(pattern)) }),
    ],
    ...
    // digit past the clip list - and a letter past the cap is never a clip.
    [
      'a placement letter with no clip behind it',
      withWorking({ ...boop, placements: 'a...............' }),
    ],
    [
      'a placement letter past the clip cap',
