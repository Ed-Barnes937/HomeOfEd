// hirameki's .iwft fixture: registers the app-specifics (harness element + root
...
import { DoodlePagePom } from './DoodlePagePom.ts'
import { IwftApp } from './IwftApp.tsx'

export const test = createIwftTest({
  harness: <IwftApp />,
  createRoot: (page) => new DoodlePagePom(page),
})
