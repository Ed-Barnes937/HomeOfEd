...
no gamification. Lives at `hirameki.homeofed.com`.

Full spec: [`.claude/tasks/hirameki-doodle/spec.md`](../../.claude/tasks/hirameki-doodle/spec.md) ·
ratified decisions: [`.claude/tasks/hirameki-doodle/decisions.md`](../../.claude/tasks/hirameki-doodle/decisions.md) ·
divergences from the design guide: [ADR 0016](../../docs/adr/0016-hirameki-doodle.md).
...
| --- | --- | --- |
| dev simulator | `pnpm dev --filter=hirameki` | real router, no Store (Vite middleware) |
| .iwft | `pnpm test --filter=hirameki` | real router in-browser, no Store |
